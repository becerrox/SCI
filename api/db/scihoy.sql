...
CREATE FUNCTION public.auditusuario ()
    ...
    BEGIN
        ...
        INSERT INTO auditoria_usuario VALUES (old.usuario, old.pass, old.nivel, old.fecha_creacion, old.fecha_modif, old.usuario_creacion, old.usuario_modif, old.status);
...
-- ddl-end --
COMMENT ON TABLE public.configuracion_bien IS 'forma adquision,
colores, estatus de uso de bien, condiciones fisicas, categoria de unidades administrativas';
-- ddl-end --
...
-- ALTER TABLE public.ubicacion DROP CONSTRAINT IF EXISTS personal_fk CASCADE;
ALTER TABLE public.ubicacion ADD CONSTRAINT personal_fk FOREIGN KEY (id_personal)
REFERENCES public.personal (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --

-- object: ubicacion_uq | type: CONSTRAINT --
-- ALTER TABLE public.ubicacion DROP CONSTRAINT IF EXISTS ubicacion_uq CASCADE;
ALTER TABLE public.ubicacion ADD CONSTRAINT ubicacion_uq UNIQUE (id_personal);
-- ddl-end --
...
-- ALTER TABLE public.equipo DROP CONSTRAINT IF EXISTS ubicacion_fk CASCADE;
ALTER TABLE public.equipo ADD CONSTRAINT ubicacion_fk FOREIGN KEY ("id_Ubicacion_ubicacion")
REFERENCES public.ubicacion (id) MATCH FULL
ON DELETE SET NULL ON UPDATE CASCADE;
-- ddl-end --
