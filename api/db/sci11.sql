...
CREATE FUNCTION public.auditpersonal ()
    ...
    BEGIN
        ...
        INSERT INTO auditoria_personal VALUES (old.CI_per, old.nombres, old.apellidos, old.cargo, old.telf_pers, old.telf_casa, old.correo, old.f_nac, old.status, new.id, new.fecha_modif);
...
CREATE FUNCTION public.auditusuario ()
    ...
    BEGIN
        ...
        INSERT INTO auditoria_usuario VALUES (old.usuario, old.pass, old.nivel, old.status, new.id, new.fecha_modif);
