...
function registrarDetallesConfiguracionAdmin(data)
{
return new Promise(function(resolver, rechazar) { 
  $.ajax({
      type:"POST",
...
function modificarDetallesConfiguracionAdmin(data,id)
{
  return new Promise(function(resolver, rechazar) { 
    $.ajax({
        type:"PUT",
...
function eliminarDetallesConfiguracionAdmin(data,id)
{
  return new Promise(function(resolver, rechazar) { 
    $.ajax({
        type:"DELETE",
...
function getDetallesConfiguracionAdminBy(filtros)
{
  return new Promise(function(resolver, rechazar) { 
    $.ajax({
        type:"GET",
          contentType: 'application/json',
        url:'api/detallesadmin/'+filtros,
        success:function(response){
          resolver(response);
        },error:function(response){
          rechazar(response);
